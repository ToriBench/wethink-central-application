...
FROM            [dbo].Courses INNER JOIN
                         ...
                         [dbo].Institutions ON [dbo].Courses.InstitutionID = [dbo].Institutions.InstitutionID
...
SELECT       [dbo].Courses.CourseID, [dbo].Institutions.Name AS Institution_Name, [dbo].Faculties.Name AS Faculty_Name, [dbo].Courses.Name AS Course_Name, [dbo].Courses.ApScore, [dbo].Courses.Description AS Course_Descr, 
...
CREATE VIEW vAddressesWithInstitutions AS
SELECT			[dbo].Addresses.AddressID, [dbo].Addresses.Province, Students.AddressID, Students.StudentID 
				FROM Addresses 
				INNER JOIN Students 
				ON Addresses.AddressID = Students.AddressID
