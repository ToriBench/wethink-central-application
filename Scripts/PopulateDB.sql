...
INSERT INTO [dbo].[Users] (Email,[PasswordHash],UserRoleID)
	...
	('vchaka@newbary.com','fgngfvbsfgn5152151d51',2,'Vusi','Chaka'),
	('zuess@mintdex.com','aef3a21e5g16123ag1',2,'Zuess','Hercules'),
	('fkruger@trudo.com','sfjtyitj65h1j65151',2,'Freddie','Kruger'),
	('juneb@zoneone.com','ty3r216ethgre6y5j1312',2,'Bianca','June'),
	('ssolomon@mintra.com','vdf32b1d65165b11h51sd',2,'Sunny','Solomon'),
	('wboyd@mintdex.com','jvnsivhbsivbsivhbvn',2,'Wonder','Boyd'),
	('gmensa@trudo.com','pigfjwkvnfoughegoj',2,'Gregory','Mensa'),
	('ubaloyi@wowwer.com','nsvojvjnefvjnojdvn',2,'Ursula','Baloyi'),
	('ambrose@newbary.com','ivjierjgsldmvnso',2,'Victor','Ambrose'),
	('yullar@mintdex.com','owurwofhjofhsfkj',2,'Mathew','Yullar'),
	('kbala@trudo.com','vnkjiurhjvnsojghd',2,'Koffi','Bala'),
