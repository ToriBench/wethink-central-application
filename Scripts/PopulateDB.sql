...
INSERT INTO [dbo].[Faculties] ([Name], [Description], InstitutionID)
	VALUES ('Law','Legal studies',4),
('Engineering','Study of the built environment',2),
('Information Technology','Study of Information Technology',8),
('Classics','Classical studies',9),
('Information Technology','Study of Information Technology',2),
('Humanities','Study of humanities',6),
('Arts','Study of arts',2),
('Law','Legal studies',2),
('Information Technology','Study of Information Technology',5),
('Natural Sciences','Study of the natural evironment',2),
('Engineering','Study of the built environment',5),
('Law','Legal studies',5),
('Education','Study of education',10),
('Management Studies','Management of business activities',9),
('Economics','Study of the economy',1),
('Natural Sciences','Study of the natural evironment',8),
('Management Studies','Management of business activities',6),
('Humanities','Study of humanities',10),
('Education','Study of education',2),
('Education','Study of education',1),
('Arts','Study of arts',5),
('Education','Study of education',3),
('Economics','Study of the economy',5),
('Economics','Study of the economy',7),
('Philosophy','Study of philosophy',10),
('Humanities','Study of humanities',3),
('Commerce','Study of commerce',6),
('Law','Legal studies',8),
('Arts','Study of arts',3),
('Information Technology','Study of Information Technology',6),
('Economics','Study of the economy',9),
('Law','Legal studies',3),
('Management Studies','Management of business activities',7),
('Arts','Study of arts',9),
('Arts','Study of arts',4),
('Law','Legal studies',10),
('Management Studies','Management of business activities',2),
('Education','Study of education',7),
('Natural Sciences','Study of the natural evironment',1),
('Humanities','Study of humanities',1),
('Information Technology','Study of Information Technology',4),
('Philosophy','Study of philosophy',2),
('Humanities','Study of humanities',5)
GO
...
INSERT INTO [dbo].[Courses](FacultyID,[Name],MonthDuration,[Description],ApScore, QualificationID)
	VALUES (13,'Bachelor of Commerce (Accounting)',36,'Accounting studies',35,3),
                (31,'Bachelor of Commerce (Information Systems)',24,'Information Systems studies',35,3),
                (36,'Bachelor of Commerce (Politics, Philosophy and Economics)',48,'Politics Philosophy and Economics studies',35,3),
                (23,'Bachelor of Commerce with Law',36,'Law studies',35,3),
                (31,'LLB Four-year stream',24,'LLB studies',35,3),
                (17,'Bachelor of Accounting Science',48,'Accounting Science studies',45,3),
                (12,'Bachelor of Economic Science',36,'Economic Science studies',45,3),
                (19,'Architecture',24,'Architecture studies',45,2),
                (23,'Urban and Regional Planning',12,'Urban and Regional Planning studies',20,2),
                (21,'Construction Studies',48,'Construction studies',40,2),
                (4,'Medicine',24,'Medicine studies',50,4),
                (36,'Nursing',36,'Nursing studies',40,1),
                (28,'Occupational Therapy',48,'Occupational Therapy studies',30,1),
                (13,'Pharmacy',48,'Pharmacy studies',25,3),
                (26,'Physiotherapy',36,'Physiotherapy studies',30,4),
                (22,'Digital Arts',36,'Digital Arts studies',50,2),
                (25,'Theatre and Performance',36,'Theatre and Performance studies',25,1),
                (42,'Film and Television',36,'Film and Television studies',25,1),
                (10,'Fine Arts and Music',12,'Fine Arts and Music studies',25,3),
                (39,'Foundation Phase Teaching',12,'Foundation Phase Teaching studies',25,2),
                (22,'Intermediate Phase Teaching',24,'Intermediate Phase Teaching studies',30,2),
                (8,'Social Work',18,'Social studies',30,2),
                (29,'BSC Actuarial Sciences',42,'Actuarial Sciences studies',45,4),
                (29,'BSC Computational and Applied Mathematics',18,'Computational and Applied Mathematics studies',45,4),
                (1,'BSC Computer Science',30,'Computer Science studies',45,3),
                (29,'BSC Mathematics',30,'Mathematics studies',45,3),
                (22,'BSC Physical Science: Physical Science',48,'Physical Science studies',45,5),
                (37,'BSC Chemistry with Chemical Engineering',48,'Chemistry studies',40,5),
                (36,'BSC Material Science',30,'Material Science studies',20,3),
                (16,'BSC Astronomy and Astrophysics',36,'Astronomy and Astrophysics studies',35,3),
                (25,'Biodiversity',36,'Biodiversity studies',50,5),
                (22,'Ecology and Conservation',48,'Ecology and Conservation studies',25,5),
                (33,'Organismal Biology',48,'Organismal Biology studies',30,4),
                (20,'Applied Bioinformatics',46,'Applied Bioinformatics studies',45,3),
                (18,'Biochemistry and Cell Biology',36,'Biochemistry studies',30,5)
GO
